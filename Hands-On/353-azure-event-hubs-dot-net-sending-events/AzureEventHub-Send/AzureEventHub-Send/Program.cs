...
namespace AzureEventHub_Send
{
    class Program
    {
        private static string connection_string = "Endpoint=sb://nsatinjune21.servicebus.windows.net/;SharedAccessKeyName=p1;SharedAccessKey=ypYsgszbfkD3h7fwlkN+X/mt8mr9ddiQy1WBDidSfUk=;EntityPath=hub1";
